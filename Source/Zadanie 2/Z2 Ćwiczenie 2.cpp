// ZADANIE 2:     ĆWICZENIE 2
// NA PODSTAWIE:  Z2 Ćwiczenie 1.cpp
// TREŚĆ:         Za pomocą uniform przesunąć trójkąt w vertex shadera, żeby wyświetlał się przy prawej krawędzi ekranu.
...
int main(void) {
    ...
    // UTWORZENIE OKNA
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Z2_2", NULL, NULL);
